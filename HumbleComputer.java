        ...
        for(int i = 0; RegisterAsString.length > i ; i++) {
            ...
            for(int StringIterator16Length = 0; NumbersContained.length() > StringIterator16Length ; StringIterator16Length++) {
                ...
                if(StringIterator16Length >= 16){
                     IndexedCharacterAsInt = Character.getNumericValue(IndexedCharacterInString[StringIterator16Length - 16]); //this allows for the loop to keep going, but resets the string thats being used
