public class assembler_test {
    ...
    public static void runAssemblerTest() {
        ...
        String Push[] = new String[]{"push","R15"};
        String Pop[] = new String[]{"pop","R15"};
        String Call[] = new String[]{"call","10"};
        String Return[] = new String[]{"return"};
        ...
        Command = HumbleAssembler.assemble(Push);
        System.out.println("Expected Value:   0110000000001111");
        System.out.println("Push Command: " + Command);
        System.out.println("");

        Command = HumbleAssembler.assemble(Pop);
        System.out.println("Expected Value:   0110010000001111");
        System.out.println("Pop Command: " + Command);
        System.out.println("");

        Command = HumbleAssembler.assemble(Call);
        System.out.println("Expected Value:   0110100000001010");
        System.out.println("Call Command: " + Command);
        System.out.println("");

        Command = HumbleAssembler.assemble(Return);
        System.out.println("Expected Value:   0110110000000000");
